...
$sql=mysqli_query($db,"INSERT INTO secus (ztime,bizid,xcus,xorg,xadd1,xadd2,xpostal,xtitle,xweburl,xphone,xmobile,xgcus,xcontact, xbillingadd)
		VALUES (now(),'$zid','$xcus','$cusname','$road','$point','$area','$owner','$contact','$mob1','$mob2','Retailer','$emp','$rout')");
