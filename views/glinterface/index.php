            ...
            <div class="panel panel-info">   
                  ...
                  <div style="text-align: right; color: red;">
                                  ...
                                  <div class="btn-group" role="group" aria-label="...">
                                          <a type="button" id="cls" class="btn btn-success" href="<?php echo URL; ?>glinterface/index/<?php echo $this->codetype; ?>"><span class="glyphicon glyphicon-leaf"></span>&nbsp;Clear</a>
