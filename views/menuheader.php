	  ...
	  <div class="wrapper">
		  <header class="main-header">
			...
			<a href="<?php echo URL; ?>/mainmenu" class="logo">
			  ...
			  <span class="logo-mini"><b>D</b>BS</span>
			  <!-- logo for regular state and mobile devices -->
			  <span class="logo-lg">DBS</span>
			</a>
			  ...
			  <div class="navbar-custom-menu pull-left">
				<ul class="nav navbar-nav">
					<ul class="nav navbar-nav">
					  ...
					  <li class="">
						  <span><p style="margin: 24px 0 0 0;color: #fff;font-weight: 600;font-size: 30px;line-height: 0px;">
			  ...
			  <?php $i=0; foreach ($mainmenus as $key=>$value){ $menuid = explode(' ', $key); $i++; ?>
				...
				<li class="treeview">
				  ...
				  <?php foreach($value as $subkey=>$submenu){ $menuurl = explode(',',$submenu)?>
					<li class="" onclick="myFunction()"><a href="<?php echo URL.$menuurl[1]; ?>"><i class="fa fa-circle-o"></i> <?php echo $menuurl[0]; ?></a></li>
				  <?php } ?> 
				  </ul>
				</li>
			  <?php } ?>  
