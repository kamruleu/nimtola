          <div class="header clearfix">		
			<ul class="nav-tabs nav ">
			  ...
			  <li><a data-toggle="tab" id="disabled" href="avascript:void(0)" onclick="loadIframe('helpframe','<?php echo URL;?>glrcptvou/voucherlist')"><strong>Receipt Voucher List</strong></a></li>
            </ul>
			<div id="result"></div>
