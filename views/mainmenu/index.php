     ...
     <div class="row">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Today's Installment Schedule</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
              </div>
            ...
            <div class="box-body table-responsive">
              <table id="toptenitem" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php if(!empty($this->insdt)){
                    foreach ($this->insdt as $key => $value) { ?>
                      <tr>
                        <td><?php echo $value['xinsnum'] ?></td>
                        <td><?php echo $value['xcus'] ?></td>
                        <td><?php echo $value['xorg'] ?></td>
                        <td><?php echo $value['xamount'] ?></td>
                      </tr>
                   <?php } } ?>
                </tbody>
              </table>
