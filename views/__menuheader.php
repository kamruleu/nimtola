	...
	<nav class="navbar navbar-inverse navbar-fixed-top navbar-custom">
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse dropdown">
		  ...
		  <?php } else {?>
            <li><a href="<?php echo URL.'profile/showuser/'.Session::get('srole'); ?>" data-toggle="tooltip" title="Change user profile here"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Profile</a></li>
