			...
			<div id="printdiv">
				...
				<div>
                    <table class="table table-bordered table-striped">
						<thead>
							<th>Sl.</th><th>Itemcode</th><th>Description</th><th style="text-align:right">Rate</th><th style="text-align:right">Qty</th><th>Unit</th><th style="text-align:right">Total</th>
						</thead>
						<tbody>
						...
						<tfoot>
							<tr>
								<td colspan="4" align="right"><strong>Total</strong></td><td align="right"><strong><?php echo $this->totqty; ?></strong></td><td></td><td align="right"><strong><?php echo $this->total; ?></strong></td>
							</tr>
							<tr>
								<td colspan="7"><strong><?php echo $this->inword; ?></strong></td>
							</tr>
							<tr>	
								<td colspan="7"><p style="text-align:left;text-align: left;margin-left: 10px;margin-top: 10px;"><b style="color:#DC2A28!important;font-size:12px;font-family: Calibri;">Additional Notes :</b></p></td>
							</tr>
							<tr>
								<td colspan="7"><strong><p style="text-align:left;text-align: left;margin-left: 40px;margin-top: 10px;font-size:12px;font-family: Calibri;"><?php echo nl2br($this->note); ?></p></strong></td>
							</tr>
						</tfoot>
					</table>
