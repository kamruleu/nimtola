			...
			<?php echo $this->breadcrumb; ?>
				...
				<div>
                    <table class="table table-bordered table-striped">
						<thead>
							<th>Sl.</th><th>Itemcode</th><th>Description</th><th>Rate</th><th style="text-align:right">Qty</th><th>UOM</th><th style="text-align:right">Total</th>
						</thead>
						<tbody>
						<?php foreach($this->vrow as $key=>$val){ ?>
							<tr>
								...
								<td align="right"><?php echo $val['xunitpur']; ?></td>
