...
class Salesreport extends Controller{
	...
	function __construct(){
		...
		function porptmenu(){
			...
			1 => array("Mobile Order Retailer"=>URL."salesreport/retailerorder","Mobile Order MRP"=>URL."salesreport/mrporder","Retailer Return"=>URL."salesreport/retailerreturn","Dealer Return"=>URL."salesreport/dealerreturn")
			);
		...
		function itemwisesales(){
			...
			$values = array(
				...
				$fields = array(array(
								...
								"xdesc-text" => 'Description_"" readonly'
								)
							);
		...
		public function showitemwisesales(){
			...
			$this->view->vrptname = "Sales of Item Code : ".$item.'; Item Description : '.$xdesc;
