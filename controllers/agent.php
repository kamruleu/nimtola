...
class Agent extends Controller{
	...
	function __construct(){
		...
		if(file_exists($file))
			...
			$this->view->table = $this->renderTable($agent);
		...
		function allcustomers(){
			...
			</div><div id="printdiv"><div style="text-align:center">'.Session::get('sbizlong').'<br/>Agent List</div><hr/>';
			$this->view->table=$btn.$table->myTable($fields, $row, "xagent")."</div>";
			$this->view->renderpage('agent/customerlist', false);
		}
